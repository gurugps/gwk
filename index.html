...
<!--                <div class="col-sm-4 text-center"></div>-->
		...
		$("#button1").click(function(){
			window.open("https://www.google.com/maps/search/?api=1&query=10.8155755,77.9956059&query_place_id=ChIJq5TbdT8hqjsR9XlncZ803Gk", '_blank');			
		  //window.location = ;
		});
			
			$("#button2").click(function(){
			window.open("https://www.google.com/maps/search/?api=1&query=11.0927765,78.1500126&query_place_id=ChIJ1TKLS9EyqjsRYmzzPI8U1YI", '_blank');			
		  //window.location = ;
		});
			
			$("#button3").click(function(){
			window.open("https://www.google.com/maps/search/?api=1&query=11.006697,77.023651&query_place_id=ChIJOQg_P3BXqDsR2lWNzmuwFL8", '_blank');			
		  //window.location = ;
		});
		</script>
    </body>
